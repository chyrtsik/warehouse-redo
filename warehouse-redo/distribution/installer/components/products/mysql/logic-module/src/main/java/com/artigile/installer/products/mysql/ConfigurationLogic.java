package com.artigile.installer.products.mysql;

import com.artigile.installer.products.mysql.wizard.panels.MySQLPanel;
import com.artigile.installer.utils.applications.NetBeansUtils;
...
public class ConfigurationLogic extends ProductConfigurationLogic {
    ...
    public void install(
        ...
        // Configure MySQL
        Configurator.getInstance().configMySQL();
    ...
    private String getInstallationID(File location) throws NativeException {
        ...
        String[] keyNames = reg.getSubKeyNames(HKLM, WindowsNativeUtils.UNINSTALL_KEY);
        for (String key : keyNames) {
            if (key.startsWith("{")) {//all IS-based installations start with this string

                String publisher = reg.valueExists(HKLM, WindowsNativeUtils.UNINSTALL_KEY + WindowsRegistry.SEPARATOR + key, "Publisher") ? reg.getStringValue(HKLM, WindowsNativeUtils.UNINSTALL_KEY + WindowsRegistry.SEPARATOR + key, "Publisher")
                        : null;
                String installSource = reg.valueExists(HKLM, WindowsNativeUtils.UNINSTALL_KEY + WindowsRegistry.SEPARATOR + key, "InstallSource") ? reg.getStringValue(HKLM, WindowsNativeUtils.UNINSTALL_KEY + WindowsRegistry.SEPARATOR + key, "InstallSource") : null;

                if (publisher != null && publisher.equals("MySQL AB")
                        && installSource != null && new File(installSource).equals(location)) {
                    String uninstallString = reg.getStringValue(HKLM, WindowsNativeUtils.UNINSTALL_KEY + WindowsRegistry.SEPARATOR + key, "UninstallString");
    ...
    public static final String WIZARD_COMPONENTS_URI =
            ...
            + "com/artigile/installer/products/mysql/wizard.xml"; // NOI18N
    public static final String MYSQL_MSI_FILE_NAME =
            ResourceUtils.getString(ConfigurationLogic.class,
            "CL.mysql.msi.installer.file");//NOI18N
    public static final String MYSQL_INSTANCE_VERSION =
            ResourceUtils.getString(ConfigurationLogic.class,
            "CL.mysql.instance.version");//NOI18N
    ...
    public static final String INSTALL_SCRIPT_UNIX =
            "com/artigile/installer/products/mysql/scripts/install.sh";
    public static final String UNINSTALL_SCRIPT_UNIX =
            "com/artigile/installer/products/mysql/scripts/uninstall.sh";
    ...
    public static final String LEGAL_RESOURCE_PREFIX =
            "com/artigile/installer/products/mysql/";
