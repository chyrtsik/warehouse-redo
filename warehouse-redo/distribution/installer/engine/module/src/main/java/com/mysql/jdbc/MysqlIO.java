 ...
 * @version $Id: MysqlIO.java,v 1.32.2.63 2005/05/02 23:10:52 mmatthews Exp $
 *
...
public class MysqlIO {
    ...
    protected MysqlIO(String host, int port, String socketFactoryClassName,
        ...
        this.mysqlConnection = socketFactory.connect(this.host, this.port, props);
        ...
        if (characterEncoding != null) {
            ...
            if (this.platformDbCharsetMatches) {
                this.sendPacket.writeStringNoNull(query, characterEncoding,
                    this.connection.getServerCharacterEncoding(), converter, 
            ...
            if (this.protocolVersion > 9) {
                ...
                if (!this.connection.getUseOnlyServerErrorMessages()) {
                    if (xOpenErrorMessage != null) {
                        ...
                        errorBuf.append(" message from server: \""); 
                    }
                }
                ...
                if (serverErrorMessage.indexOf("Unknown column") != -1) {
                    ...
                    String xOpenErrorMessage = SQLError.get(SQLError.SQL_STATE_COLUMN_NOT_FOUND);
                    ...
                    throw new java.sql.SQLException(errorBuf.toString(),
                    		SQLError.SQL_STATE_COLUMN_NOT_FOUND, -1);
                } else {
                	StringBuffer errorBuf = new StringBuffer();

                    String xOpenErrorMessage = SQLError.get(SQLError.SQL_STATE_GENERAL_ERROR);
