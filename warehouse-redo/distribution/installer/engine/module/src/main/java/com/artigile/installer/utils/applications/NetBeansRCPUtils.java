 ...
 * copyright holder.
 */
package com.artigile.installer.utils.applications;
...
public class NetBeansRCPUtils {
    ...
    public static File getApplicationUserDirFile(File appLocation) throws IOException {
        ...
        if (SystemUtils.isWindows()) {
            ...
            try {
                if (reg.keyExists(WindowsRegistry.HKCU, key)
                        && reg.valueExists(WindowsRegistry.HKCU, key, "AppData")) {
                    userHome = reg.getStringValue(WindowsRegistry.HKCU, key, "AppData", false);
    ...
    public static final String SPACES_PATTERN = "\\ *"; // NOI18N
    public static final String DEFAULT_USERDIR = "default_userdir="; // NOI18N
    public static final String DEFAULT_USERDIR_MAC = "default_mac_userdir="; // NOI18N
    public static final String USER_HOME_TOKEN = "${HOME}"; // NOI18N
    public static final String APPNAME_TOKEN = "${APPNAME}"; // NOI18N
