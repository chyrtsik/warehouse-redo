 ...
 * @version $Id: Connection.java,v 1.31.2.97 2005/06/22 12:33:33 mmatthews Exp $
 *
...
public class Connection implements java.sql.Connection {
    ...
    protected String getCharsetNameForIndex(int charsetIndex)
        ...
        if ((versionMeetsMinimum(5, 0, 3) || 
				...
				"ms932".equalsIgnoreCase(charsetName)) {
    ...
    ResultSet execSQL(String sql, int maxRows, Buffer packet,
        ...
        synchronized (this.mutex) {
            ...
            if ((this.highAvailability) && 
            		(this.needsPing || this.failedOver)) {
                	...
                	if (realJavaEncoding != null) {
	                    if ("ISO8859_2".equals(realJavaEncoding)
	                        ...
	                        throw new SQLException(
	                            ...
	                            + "\nSpecify one of the above encodings using the 'mysqlEncoding' connection property.",
	                            SQLError.SQL_STATE_INVALID_CONNECTION_ATTRIBUTE);
	                    } else if (("MS932".equalsIgnoreCase(realJavaEncoding) 
								|| "WINDOWS-31J".equalsIgnoreCase(realJavaEncoding)) 
								&& this.io.versionMeetsMinimum(4, 1, 11)) {
							this.mysqlEncodingName = "cp932";
	                    } else if ("EUC_JP_Solaris".equalsIgnoreCase(realJavaEncoding) &&
	                    		this.io.versionMeetsMinimum(5, 0, 3)) {
    ...
    private void initializeDriverProperties(Properties info)
    	...
    	if (info.getProperty("useSqlStateCodes") != null) {
    		this.useSqlStateCodes = ("TRUE".equalsIgnoreCase(info.getProperty("useSqlStateCodes")));
    	} else {
    ...
    private boolean shouldFallBack() {
        ...
        || (this.queriesIssuedFailedOver >= this.queriesBeforeRetryMaster));
    }
