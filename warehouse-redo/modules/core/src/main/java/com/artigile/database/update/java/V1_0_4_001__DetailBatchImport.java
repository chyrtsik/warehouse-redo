...
import com.artigile.warehouse.gui.menuitems.details.batchesImport.DetailBatchesImportList;
 ...
 */
public class V1_0_4_001__DetailBatchImport implements JavaMigration {
    ...
    public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
        ...
        //Permission to view detail batch history (story #991).
        initPermission(PermissionType.VIEW_DETAIL_BATCHES_IMPORT, "permission.viewDetailBatchesImport");
        initPermission(PermissionType.EDIT_DETAIL_BATCHES_IMPORT, "permission.editDetailBatchesImport");

        //New menu item for detail batches import (story #991).
         initMenuItem("menutree.warehouse.batches.import", PluginType.TABLE_REPORT, DetailBatchesImportList.class, PermissionType.VIEW_DETAIL_BATCHES_IMPORT);
    }
