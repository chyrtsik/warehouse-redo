 ...
 */
public class BeforeUnreserveVerification implements Verification {
    private long countToUnreserve;

    public BeforeUnreserveVerification(long countToUnreserve) {
        this.countToUnreserve = countToUnreserve;
    }
    ...
    public VerificationResult verify(Object obj) {
        ...
        else if (warehouseBatch.getReservedCount() < countToUnreserve){
            return new VerificationResult(I18nSupport.message("warehousebatch.verification.notEnoughWaresToUnreserve"));
        }
