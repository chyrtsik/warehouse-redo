 ...
 */
public class DetailBatchReservesCommand extends CustomCommand {

    public DetailBatchReservesCommand() {
        super(new ResourceCommandNaming("detail.batches.command.reserveList"),
    ...
    protected boolean doExecute(ReportCommandContext context) throws ReportCommandException {
        WareHouse.runPlugin(new TableFramePlugin(new DetailBatchReservesList((DetailBatchTO) context.getCurrentReportItem())));
        return true;
    }
}
