 ...
 */
public class QuickAddItemToPostingCommand extends CustomCommand {
    private PostingTOForReport posting;

    public QuickAddItemToPostingCommand(PostingTOForReport posting) {
        super(new ResourceCommandNaming("posting.items.editor.quickAddToPosting.command"), new PermissionCommandAvailability(PermissionType.EDIT_POSTING_ITEMS));
        this.posting = posting;
    }

    @Override
    protected boolean doExecute(ReportCommandContext context) throws ReportCommandException {
        //Add new detail batch to the posting items list.
