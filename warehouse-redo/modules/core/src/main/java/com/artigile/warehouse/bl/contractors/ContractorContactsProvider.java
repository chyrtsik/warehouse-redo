...
/**
 * Provider of contractor contacts to be used in printing.
 *
 * @author Aliaksandr.Chyrtsik, 01.02.13
 */
public class ContractorContactsProvider implements DynamicObjectFieldsProvider {
    private static final String PROVIDER_NAME = "contractorContactsProvider";
    ...
    public List<String> getAvailableFields() {
        return contractorService.getAllUniqueAppointments();
    }
    ...
    public Object getFieldValue(Object object, String dynamicField) {
        ...
        else if (object instanceof ContractorTO){
            ContractorTO contractor = (ContractorTO)object;
            Contact contact = contractorService.getContractorContactByAppointment(contractor.getId(), dynamicField);
