 ...
 */
public final class EqualLessFilter extends BaseFilter {

    public EqualLessFilter(String filterText, int column) {
        super(filterText, column);
    }

    @Override
    public BaseFilter makeClone() {
        BaseFilter filter = new EqualLessFilter(text, getColumnIndex());
