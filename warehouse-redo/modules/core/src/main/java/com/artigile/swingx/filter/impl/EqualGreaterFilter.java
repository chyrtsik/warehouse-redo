 ...
 */
public final class EqualGreaterFilter extends BaseFilter {

    public EqualGreaterFilter(String filterText, int column) {
        super(filterText, column);
    }

    @Override
    public BaseFilter makeClone() {
        BaseFilter filter = new EqualGreaterFilter(text, getColumnIndex());
