 ...
 */
public final class GreaterFilter extends BaseFilter {

    public GreaterFilter(String filterText, int column) {
        super(filterText, column);
    }

    @Override
    public BaseFilter makeClone() {
        BaseFilter filter = new GreaterFilter(text, getColumnIndex());
