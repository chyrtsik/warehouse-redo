 ...
 */
public class CurrencyStyleFactory implements StyleFactory {
    private Style detaultCurrencyStyle = new Style(new Color(200, 255, 200));

    @Override
    public Style getStyle(Object rowData) {
        CurrencyTO currencyTO = (CurrencyTO) rowData;
        return currencyTO.getDefaultCurrency() ? detaultCurrencyStyle : null;
    }
}
