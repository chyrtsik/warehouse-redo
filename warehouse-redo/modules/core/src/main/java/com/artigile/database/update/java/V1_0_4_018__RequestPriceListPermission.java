 ...
 */
public class V1_0_4_018__RequestPriceListPermission implements JavaMigration {
    ...
    public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
        ...
        initUserPermission(PermissionType.REQUEST_PRICE_LIST, "permission.request.price.list");
    }
