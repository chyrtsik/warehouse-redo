 ...
 */
public class V1_0_4_021__SelectedPositionsPurchasePermission implements JavaMigration {
    ...
    public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
        ...
        initUserPermission(PermissionType.REQUEST_SELECTED_POSITIONS_PURCHASE, "permission.request.selected.positions.purchase");
    }
